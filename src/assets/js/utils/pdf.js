...
$(function() {
    ...
    $('#cmd').click(function() {
        ...
        doc.setFontSize(12);
        doc.setTextColor(35, 62, 153);
        doc.text(20, 45, 'Perfil inversor');
        ...
        doc.setFontSize(11.5);
        doc.setTextColor(0, 0, 0);
        doc.text(20, 76, perfilesData[indexPerfil].descripcion);
        ...
        doc.setFontSize(12);
        doc.setTextColor(35, 62, 153);
        doc.text(20, 102, 'Descripción Estratégica de Activos');
        ...
        doc.setFontSize(12);
        doc.setTextColor(35, 62, 153);
        doc.text(20, 182, 'Retorno esperado: ');
        ...
        doc.setFontSize(11.5);
        doc.setTextColor(0, 0, 0);
        doc.text(20, 220, perfilesData[indexPerfil].retorno_texto);

        //Tabla        
        doc.addImage(perfilesData[indexPerfil].tabla, 'PNG', 20, 230, 160, 0);
        ...
        doc.setFontSize(11.5);
        doc.setTextColor(0, 0, 0);
        doc.text(100, 265, "______________________________");
        ...
        doc.setFontSize(12);
        doc.setTextColor(0, 0, 0);
        doc.text(100, 273, "______________________________");
