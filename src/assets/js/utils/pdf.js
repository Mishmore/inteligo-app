...
$(function() {
     ...
     $('#cmd').click(function() {
         ...
         doc.addImage(logotipo, 'PNG', 25, 21, 50, 9); //Logo
         doc.addImage(perfilesData[indexPerfil].grafico, 'PNG', 70, 155, 70, 60); //Grafico
         doc.addImage(perfilesData[indexPerfil].tabla, 'PNG', 25, 20, 160, 0); //Tabla
        ...
        doc.fromHTML($('#identificador').html(), 155, 38, { //Identificador de cliente
         ...
         doc.text(140, 18, 'Reporte del perfil inversor');

         doc.setFont('Arial');
         doc.setFontType('normal');
         doc.setFontSize(12);
         doc.text(20, 30, 'Retorno esperado: ');

         doc.setFont('Arial');
         doc.setFontType('normal');
         doc.setFontSize(12);
         doc.text(50, 30, perfilesData[indexPerfil].retorno_result);
